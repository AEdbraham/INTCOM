...
const SearchPage = () => {
    ...
    const searchBlogs = ({ page = 1, create_new_arr = false }) => {
        ...
        .catch(err => {
            console.log(err);
            toast.error("No se pueden buscar blogs en este momento");
        })
    ...
    useEffect(() => {
        ...
        .catch(err => {
            toast.error("No se pueden buscar usuarios en este momento");
            console.log(err);
        })
    ...
    return (
        <section className="h-cover flex justify-center gap-10">
            ...
            <div className="w-full">
                <InPageNavigation routes={ [`Resultados de la búsqueda de "${query}"`, "Cuentas Emparejadas"] } defaultHidden={["Cuentas Emparejadas"]}>
            ...
            <div className="min-w-[40%] lg:min-w-[350px] max-w-min border-l border-grey pl-8 pt-3 max-md:hidden">
                ...
                <h1 className="font-medium text-xl mb-8">Usuarios relacionados con la búsqueda <i className="fi fi-rr-user ml-2 mt-1"></i></h1>
