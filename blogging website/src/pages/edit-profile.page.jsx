...
const EditProfile = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if(username.length < 3) {
            return toast.error("Debe rellenar el nombre de usuario con más de 3 letras");
        } 
        if(bio.length > bioLimit){
            return toast.error(`la Biografía no debe ser más de ${bioLimit}`)
        }
                    ...
                    <div className='flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10'>
                        <div className='max-lg:center mb-5'>
                            <label htmlFor="UploadImage" id="profileImgLable" className="relative block w-48 h-48 bg-grey rounded-full overflow-hidden">
                                <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center text-white bg-black/80 opacity-0 hover:opacity-100 cursor-pointer">Subir imagen</div>
                        ...
                        <div className="w-full">
                            <div className='grid grid-cols-1 md:grid-cols-2 md:gap-5'>
                                <div>
                                    <InputBox name="fullname" type="text" value={fullname} placeholder="Nombre Completo" icon="fi-sr-user"  disable={true} />
                                </div>
                                <div>
                            ...
                            <InputBox name="username" type="text" value={profile_username} placeholder="Usuario" icon="fi-sr-at" />
                            <p className="text-dark-grey -mt-3">El nombre de usuario se utilizará para buscar usuarios y será visible para todos</p>
                            ...
                            <p className="my-6 text-dark-grey">Añade tus contactos sociales a continuación</p>
