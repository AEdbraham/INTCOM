...
const ManageBlogs = () =>{
    ...
    return (
        <>
            <h1 className="max-md:hidden">Gestionar blogs</h1>
            ...
            <InPageNavigation routes={["Blogs Publicados", "Borradores"]} defaultActiveIndex={ activePage != 'draft' ? 0 : 1 } >
                ...
                {   // draft blog cards
                    ...
                    : <NoDataMessage message="Nada en borradores" /> 
                }
