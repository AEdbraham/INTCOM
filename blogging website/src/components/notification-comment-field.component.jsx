...
const NotificationCommentField = ({ _id, blog_author, index = undefined, replyingTo = undefined, setReplying, notification_id, notificationData }) => {
    ...
    return (
        <>
            <Toaster />
            <textarea onChange={(e) => setComment(e.target.value)} placeholder="Deja un comentario..." className="input-box pl-5 placeholder:text-dark-grey resize-none h-[150px] overflow-auto" ></textarea>
