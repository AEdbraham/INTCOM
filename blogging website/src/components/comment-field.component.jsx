...
const CommentField = ({ action, index = undefined, replyingTo = undefined, setReplying }) => {
    ...
    const handleComment = () => {
        ...
        if(!comment.length) { 
            return toast.error("Escribe algo para dejar un comentario...");
        }
    ...
    return (
        <>
            <Toaster />
            <textarea value={comment} onChange={(e) => setComment(e.target.value)} placeholder="Dejar un comentario..." className="input-box pl-5 placeholder:text-dark-grey resize-none h-[150px] overflow-auto" ></textarea>
